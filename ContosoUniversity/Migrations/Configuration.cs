namespace ContosoUniversity.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ContosoUniversity.DAL.SchoolContext>
    {
        ...
        protected override void Seed(ContosoUniversity.DAL.SchoolContext context)
        {
            ...
            //The first parameter passed to the AddOrUpdate method specifies the property to use
            //to check if a row already exists. For the test student data that you are providing, 
            ...
            {
                new Enrollment {
                    //the ID value is set when you call SaveChanges for the students collection. 
