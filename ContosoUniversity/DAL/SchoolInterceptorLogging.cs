...
//create the classes that the Entity Framework will call into every time it is going to send a query to the database,
...
//method overrides that are automatically called when query is about to be executed.
